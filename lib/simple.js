...
export function makeWASocket(connectionOptions, options = {}) {
     ...
     */
        sendContact: {
        async (jid, number, name, quoted, options) {
...
END:VCARD`.trim()
    ...
    */
    sendList: {
    async(jid, title, text, footer, buttonText, buffer, listSections, quoted, options) {
    ...
    async (message, filename, attachExtension = true) {
    ...
    */
     ...
     * @param {Object} options 
     */
    sendButtonDoc: { (jid, content, footerText, button1, id1, quoted, options) {
      const buttons = [
    ...
    /* */
    send2ButtonDoc: { (jid, content, footerText, button1, id1, button2, id2, quoted, options) {
        const buttons = [
        { buttonId: id1, buttonText: { displayText: button1 }, type: 1 },
    ...
    /* */
    send2ButtonImgDoc: { (jid, buffer, contentText, footerText, button1, id1, button2, id2, quoted, options) {
    ...
    /* */
    send2Button: { (jid, content, footerText, button1, id1, button2, id2, quoted, options) {
        const buttons = [
        { buttonId: id1, buttonText: { displayText: button1 }, type: 1 },
        { buttonId: id2, buttonText: { displayText: button2 }, type: 1 }
        ]
    ...
    /* */
    send3Button: { (jid, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
        const buttons = [
        { buttonId: id1, buttonText: { displayText: button1 }, type: 1 },
        { buttonId: id2, buttonText: { displayText: button2 }, type: 1 },
     ...
     * @param {Object} options 
     */
    sendButtonLoc: { (jid, buffer, content, footer, button1, row1, quoted, options = {}) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
    ...
    /* */
    send2ButtonLoc: { (jid, buffer, content, footer, button1, row1, button2, row2, quoted, options = {}) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
    ...
    /* */
    send3ButtonLoc: { (jid, buffer, content, footer, button1, row1, button2, row2, button3, row3, quoted, options = {}) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
     ...
     * @param {Object} options 
     */
    sendButtonImg: { (jid, buffer, contentText, footerText, button1, id1, quoted, options) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
    ...
    /* */
    send2ButtonImg: { (jid, buffer, contentText, footerText, button1, id1, button2, id2, quoted, options) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
    ...
    /* */
    send3ButtonImg: { (jid, buffer, contentText, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
     ...
     * @param {Object} options 
     */
    sendButtonVid: { (jid, buffer, contentText, footerText, button1, id1, quoted, options) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
    ...
    /* */
    send2ButtonVid: { (jid, buffer, contentText, footerText, button1, id1, button2, id2, quoted, options) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
    ...
    /* */
    send3ButtonVid: { (jid, buffer, contentText, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
    ...
    * @param {Object} quoted 
    */
    send3TemplateButtonImg: { (jid, buffer, content, footerText, button1, id1, button2, id2, button3, id3, quoted, options) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
        ...
        const buttons = [
            { index: 1, urlButton: { displayText: author, url: sgh } },
    ...
    /* */
    sendTemplateButtonDoc: { (jid, buffer, content, footerText, button1, id1, quoted, options) {
        const buttons = [
            { index: 1, urlButton: { displayText: author, url: sgh } },
            { index: 2, callButton: { displayText: nameown,  phoneNumber: nomorown } },
    ...
    /* */
    sendTemplateButtonLoc: { (jid, buffer, contentText, footer, buttons1, row1, quoted, options) {
    ...
    /* */
    sendTemplateButtonFakeImg: { (jid, buffer, content, footerText, btn1, id1, options) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
    ...
    /* */
    send2TemplateButtonFakeImg: { (jid, buffer, content, footerText, btn1, id1, btn2, id2, quoted, options) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
    ...
    /* */
    send3TemplateButtonFakeImg: { (jid, buffer, content, footerText, btn1, id1, btn2, id2, btn3, id3, quoted, options) {
        let type = await conn.getFile(buffer)
        let { res, data: file } = type
        if (res && res.status !== 200 || file.length <= 65536) {
        try { throw { json: JSON.parse(file.toString()) } }
